...
Run with the container venv python (the model libs live in the image):

    apptainer exec --cleanenv --bind /scratch ngiab-2i2c_v1.2.3.sif \
        /ngen/.venv/bin/python notebooks/run_model.py

Redirect data location to scratch:

    NGIAB_HOME=/scratch/mhchowdhury apptainer exec ... /ngen/.venv/bin/python notebooks/run_model.py
"""
